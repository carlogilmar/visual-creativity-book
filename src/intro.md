...
El capítulo 2 es sobre la importancia de conocer nuestra cultura y nuestras **concepciones sobre la creatividad**. 

El capítulo 3 aborda el tema de la **creatividad visual** y cómo todos la tenemos. 

El capítulo 4 habla de crear un **laboratorio de exploración**, un lugar físico donde puedan existir libremente tus ideas, para pasar al capítulo 5 que trata sobre qué es el **visual thinking**. 

Y finalmente el capítulo 6 es un conjunto de estrategias con las que puedes aplicar todo lo anterior. 
